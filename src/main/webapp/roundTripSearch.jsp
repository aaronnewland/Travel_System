...
<%
    ...
    //passed from customerlanding page
%>
...
<%
    ...
    try {
        ...
        while (rs.next()) {
            ...
            out.println("<td>");
            out.println("<form action='returnTripSearch.jsp' method='POST'>");
            ...
            out.println("<input type='hidden' name='arrival' value='" + arrival_city + "'>");
            out.println("<input type='hidden' name='arrivalDate' value='" + arrival_time + "'>");
            out.println("<input type='submit' value='Select this departing flight.'>");
            out.println("</form>");
            out.println("</td>");
            out.println("</tr>");
